...
const AccountCredentials = ({ control, errors }: Props) => {

  return (
    <FormSection title="Account Credentials" delay={150}>
      <Text className="text-slate-400 text-xs mb-4 leading-5">
        The citizen will use these credentials to log in to the Barangay portal.
      </Text>
      ...
      <Controller
        ...
        rules={{
          ...
          pattern: {
            value: /^[a-zA-Z0-9_.\-]+$/,
            message: 'Letters, numbers, underscore, hyphen, dot only',
          },
        }}
        render={({ field: { onChange, value } }) => (
          <TextField label="Username *" error={errors.username?.message}>
            <View
            ...
            >
              ...
              <TextInput
                ...
                placeholder="juan_delacruz (min. 5 chars)"
